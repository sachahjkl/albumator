    ...
    task "web" {
      ...
      service {
        ...
        tags = [
          ...
          "traefik.http.routers.albumator-staging.rule=Host(`[[ var "domain" . ]]`)",
          "traefik.http.routers.albumator-staging.tls.domains[0].main=[[ var "domain" . ]]",
...
job "albumator" {
  ...
  group "web" {
    ...
    volume "data" {
      type            = "host"
      source          = "albumator-production-data"
      attachment_mode = "file-system"
      access_mode     = "single-node-writer"
      sticky          = true
    }
    ...
    task "web" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.albumator-production.entrypoints=websecure",
          "traefik.http.routers.albumator-production.rule=Host(`[[ var "domain" . ]]`)",
        ]
